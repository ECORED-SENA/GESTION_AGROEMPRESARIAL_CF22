        ...
        .row.justify-content-center
          .col-lg-6.col-md-12.col-11.mb-4
            .tarjeta-avatar1
              ...
              .tarjeta.tarjeta-blanca
                .p-4
                  p.mb-0 <b> <FONT COLOR="#A3314F"> Condición corporal: </FONT> </b> presentar buen estado físico, sin lesiones o alteraciones que puedan afectar su actividad reproductiva.
                  p.mb-0 <b> <FONT COLOR="#A3314F"> Comprobado valor genético: </FONT> </b> de ser posible tener registros de sus progenitores y sus calidades.
                  p.mb-0 <b> <FONT COLOR="#A3314F"> Interés en la monta: </FONT> </b> manifestar deseo y capacidad de realizar una monta completa. 
          ...
          .col-lg-6.col-md-12.col-11.mb-4
            .tarjeta-avatar1
              ...
              .tarjeta.tarjeta-blanca
                .p-4
                  p.mb-0 <b> <FONT COLOR="#A3314F"> Porcentaje de fertilidad: </FONT> </b> fácil concepción e intervalos cortos entre parto - concepción.
                  p.mb-0 <b> <FONT COLOR="#A3314F"> Aplomos y pezuñas: </FONT> </b> pezuñas fuertes y saludables para caminar y soportar sin problemas el proceso de monta. 
          ...
          .col-md-7
            ul.lista-ul--color
              li 
                ...
                | La hembra se muestra nerviosa.
              li 
                i.fas.fa-angle-right
                | Las hembras comienzan a montarse entre sí o se dejan montar por otras hembras.
              li 
                i.fas.fa-angle-right
                | Mueven la cola frecuentemente, a veces dejando expuestos sus órganos reproductivos. 
              li 
                i.fas.fa-angle-right
                | Presencia de moco espeso y transparente en la vulva. 
              li 
                i.fas.fa-angle-right
                | Pérdida de apetito. 
              li 
          ...
          SlyderA(tipo="b")
            .row
              .col-md-5.mb-4.mb-md-0
                h5.mb-5 Toros calentadores
                p Para esto se utilizan machos a los cuales quirúrgicamente se les ha quitado la habilidad de reproducirse (desviación de pene o vasectomía). Estos machos tienen la función de marcar a las hembras del hato que se encuentren en calor. 
              .col-md-7
                figure
            ...
            .row
              .col-md-5.mb-4.mb-md-0
                h5.mb-5 Valla receladora
                p Se utiliza principalmente en yeguas. Consiste en una valla que separa a la hembra del macho pero les permite estar en contacto. La yegua en celo manifiesta receptividad hacia el macho. 
              .col-md-7
                figure
            ...
            .row
              .col-md-5.mb-4.mb-md-0
                h5.mb-5 Presentación del macho
                p En porcicultura se acostumbra pasear el macho frente a las hembras para identificar signos de aceptación. En caso de encontrar alguna hembra con estos signos esta se traslada al corral del macho para la cópula. 
              .col-md-7
                figure
        ...
        .row
          .col-lg-6
            .tarjeta-avatar-b.mb-5
              ...
              .tarjeta.color-avatar
                .p-4
                  h5 Preparar el suelo
                  p Preparar el suelo del corral con suficiente viruta o cascarilla para evitar que los animales se resbalen durante la cópula. 
          ...
          .col-lg-6
            .tarjeta-avatar-b.mb-5
              ...
              .tarjeta.color-avatar
                .p-4
                  h5 Asegurar el aseo del macho
                  p En los machos asegurar el aseo de la zona prepucial. Incluso es recomendable utilizar agua y posteriormente secar. 
          ...
          .col-lg-6
            .tarjeta-avatar-b.mb-5
              ...
              .tarjeta.color-avatar
                .p-4
                  h5 Asegurar el aseo de la hembra
                  p En la hembra limpiar y lavar, si es necesario, la zona alrededor de la vulva. Igualmente, si se lava se debe secar.  

          .col-lg-6
            .tarjeta-avatar-b.mb-5
              .tarjeta-avatar-b__img
                img(src='@/assets/curso/tema2/avatar6.svg' alt='AvatarTop')
              .tarjeta.color-avatar
                .p-4
                  h5 Espacio de interacción
    ...
    datosSlyder: [
      {
        titulo: 'Cerdas',
        texto:
          'En el caso de las cerdas, estas presentan ciclos reproductivos durante todo el año, los cuales comienzan entre los 150 y 170 días de edad. La duración de estos ciclos es de 21 días en promedio y solamente cesan su aparición en las etapas de gestación y lactancia. En esta especie el celo puede durar entre 48 y 72 horas, siendo más prolongado en hembras adultas. ',
        imagen: require('@/assets/curso/tema2/1.jpg'),
      },
      {
        titulo: 'Ganado bovino',
        texto:
          'En el ganado bovino, en algunas razas especializadas, el celo comienza a manifestarse desde los 6 hasta los 18 meses y entre los 14 y 18 meses en bovinos criollos. En esta especie el primer servicio, dependiendo de la raza y de la alimentación y salud de la novilla, se puede realizar a los 18 meses, aunque es preferible realizarlo cuando el animal ha alcanzado el 65 % de su peso adulto.',
        imagen: require('@/assets/curso/tema2/2.jpg'),
      },
      {
        titulo: 'Caprinos',
        texto:
          'En los caprinos, el primer celo se da entre los 6 y los 12 meses, aunque se recomienda que el primer servicio se lleve a cabo cuando la hembra tenga por lo menos 30 kilogramos de peso, pues de lo contrario es posible que se tengan problemas en el parto, bajo peso y una baja producción de leche. ',
