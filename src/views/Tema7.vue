  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row  
      .col-md-12
        TabsB.color-acento-contenido.fondo5
          ...
          .fondo6.py-4.py-md-5(titulo="Parámetros productivos" :icono="require('@/assets/curso/tema7/icon2.svg')")
            .row.justify-content-center.align-items-top
              .col-md-7.mb-0.mb-md-0
                h4.mb-5 Parámetros productivos
          ...
          .fondo7.py-4.py-md-5(titulo="Infraestructura" :icono="require('@/assets/curso/tema7/icon3.svg')")
            .row.justify-content-center.align-items-top.p-4
              .col-md-6.mb-0.mb-md-0
                h4.mb-5 Infraestructura
          ...
          .fondo8.py-4.py-md-5(titulo="Mantenimiento de maquinaria y equipos" :icono="require('@/assets/curso/tema7/icon4.svg')")
            .row.justify-content-center.align-items-top.p-5
              .col-md-6.mb-0.mb-md-0
                h4.mb-5 Mantenimiento de maquinaria y equipos
          ...
          .fondo9.py-4.py-md-5(titulo="The splendor of the mystery" :icono="require('@/assets/curso/tema7/icon5.svg')")
            .row.justify-content-center.align-items-top.p-5
              .col-md-6.mb-0.mb-md-0
                h4.mb-5 Inventarios
    ...
    SlyderF.mb-5(columnas="col-lg-6 col-xl-4")
      ...
      .tarjeta.color-gris.p-4
        ...
        h5.text-center Inventario de animales.

      .tarjeta.color-gris.p-4
        .row.justify-content-center.mb-3
          .col-8
            img(src='@/assets/curso/tema7/avatar3.svg' alt='AvatarTop')
        h5.text-center Inventario de cobertura del suelo.

      .tarjeta.color-gris.p-4
        .row.justify-content-center.mb-3
          .col-8
            img(src='@/assets/curso/tema7/avatar4.svg' alt='AvatarTop')
        h5.text-center Inventario de equipos y herramientas.
        ...
        .row
          .col-lg-12
            .tarjeta-avatar-b.mb-2
              ...
              .tarjeta.color-avatarb
                .p-3.mb-0
                  p <b>Inventario de materias primas e insumos:</b> se organiza la información relacionada con este tipo de productos dentro de la unidad productiva. Además de las cantidades y la descripción es importante señalar las fechas de vencimiento o caducidad de los productos. 
          ...
          .col-lg-12
            .tarjeta-avatar-b.mb-2
              ...
              .tarjeta.color-avatarb
                .p-3.mb-0
                  p <b>Inventario de animales:</b> se debe señalar la edad de los animales, su sexo, raza, edad y peso. Igualmente, es importante tener datos adicionales sobre su procedencia y comportamiento productivo. 
          ...
          .col-lg-12
            .tarjeta-avatar-b.mb-2
              ...
              .tarjeta.color-avatarb
                .p-3.mb-0
                  p <b>Inventario de coberturas del suelo:</b> identificar el número de potreros de la unidad productiva y establecer las especies vegetales que allí se encuentran. Se puede combinar con aforos para medir la disponibilidad de alimento para los animales en pastoreo. 
          ...
          .col-lg-12
            .tarjeta-avatar-b.mb-2
              ...
              .tarjeta.color-avatarb
                .p-3.mb-0
                  p <b>Inventario de equipos y herramientas:</b> establecer qué tipo de herramientas se tienen en la unidad productiva, su estado y su disponibilidad. En el caso de los equipos también se debe registrar en el inventario si cuentan o no con accesorios y manuales de operación. 
